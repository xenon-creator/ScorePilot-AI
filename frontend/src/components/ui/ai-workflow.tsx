...
import { Upload, ScanText, Brain, UserCheck, BarChart3 } from 'lucide-react'
    ...
    <section id="workflow" className="relative py-24 md:py-32 lg:py-40">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="relative">
          ...
          <div className="absolute left-8 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-white/[0.08] to-transparent lg:hidden" />
              ...
              return (
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    <div className="glass-card glass-card-hover rounded-2xl p-6 max-w-md">
